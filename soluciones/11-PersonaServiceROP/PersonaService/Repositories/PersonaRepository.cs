...
public class PersonaRepository : IPersonaRepository
{
    ...
    private void SeedData()
    {
        ...
        _logger.Information("Seed data cargada: {Count} registros", seedData.Count);
    }
    ...
    public Persona? Delete(int id, bool logical = true)
    {
        ...
        _context.SaveChanges();
        _logger.Information("Delete: Persona {Id} eliminada - Logical: {Logical}", id, logical);
        return persona;
    }
