...
public static class DependenciesProvider
{
    ...
    private static void RegisterServices(IServiceCollection services)
    {
        ...
        // --- OPCIÓN 4: Mezcla de ciclos de vida ---
        // Por ejemplo, el calentador es singleton (compartido), pero la cafetera es transient (nueva cada vez).
        // Esto es posible porque el contenedor DI maneja la creación de dependencias automáticamente.
        services.AddSingleton<ICalentador, CalentadorElectrico>();
        services.AddTransient<IBomba, Termosifon>();
        services.AddTransient<ICafetera, Cafetera>();
    }
