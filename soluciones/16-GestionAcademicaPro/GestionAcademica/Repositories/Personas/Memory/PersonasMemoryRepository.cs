...
public class PersonasMemoryRepository : IPersonasRepository
{
    ...
    public Persona? Update(int id, Persona model)
    {
        ...
        // Si cambió el DNI, verificar que no exista en otra persona, y si existe, no permitir la actualización
        // Pero si el DNI existe pero es de la misma persona (mismo id), sí permitir la actualización (caso de no cambiar el DNI)
