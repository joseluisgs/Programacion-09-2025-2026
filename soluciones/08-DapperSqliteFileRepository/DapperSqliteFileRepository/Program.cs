...
Console.WriteLine("=== Dapper SQLite File Repository ===");
Console.WriteLine();

// Crear conexión SQLite en archivo
var connection = new SqliteConnection("Data Source=personas.db");
connection.Open();
...
try {
    ...
    var duplicateEmail = repository.Create(new Persona { Nombre = "Juan Duplicate", Email = firstEmail, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false });
